/*PRODUCTOS (nro_producto, nom_producto, stock)
 ...
 nro_pedido es único/*Se tienen las siguientes relaciones:
...
DETALLE_PEDIDOS (nro_pedido, nro_producto, cantidad) nro_producto es único por pedido * / CREATE TABLE PRODUCTOS (
